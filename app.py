...
def handle_incoming(from_number, user_message):
    ...
    try:
        ...
        print(f"AI Error: {e}")
        return "Sorry, I'm facing some technical issues right now. Please try again in a moment! 🙏"
...
1. Go back to your repo → click `requirements.txt`
2. Click **pencil icon ✏️**
3. **Select all → delete** → paste this:
```
flask
requests
python-dotenv
